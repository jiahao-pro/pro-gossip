...
public class MemberView extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<div class='leftPannel'>");
		...
		messages.forEach((millis, blabla) -> {
			LocalDateTime dateTime = Instant.ofEpochMilli(millis).atZone(ZoneId.of("Asia/Taipei")).toLocalDateTime();
			...
			out.println("<button type='sumbit'>刪除</button>");
			out.println("</form>");
